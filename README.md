...
> Άνοιγμα αυτής της σελίδας στο [https://maravelias.github.io/makecode/](https://maravelias.github.io/makecode/)
...
* αναζήτηση για **https://github.com/maravelias/makecode** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/maravelias/makecode/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/maravelias/makecode** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/maravelias/makecode/raw/master/.github/makecode/blocks.png)
